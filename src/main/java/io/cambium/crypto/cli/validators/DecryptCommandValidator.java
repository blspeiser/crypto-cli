...
public class DecryptCommandValidator extends BaseValidator {
  ...
  public void validate(Map<String, Object> parameters) throws ParameterException {
    ...
    if(asymmetric || hybrid) {
      if(isNotValued(parameters, "-priv", "--private-key")) {
        throw new ParameterException("You must specify the private key file");
      }  
    }
